...
<div class="corpo">
    <div class="tab" onload="openCity('Tab1')">
        <button class="tablinks" onclick="openCity(event, 'Tab1', 'pages/constituicao.php')">Constituição</button>
        <button class="tablinks" onclick="openCity(event, 'Tab1', 'pages/complementares.php')">Leis Complementares</button>
        <button class="tablinks" onclick="openCity(event, 'Tab1', 'pages/decretos.php')">Decretos</button>
    </div><!--tab-->
